...
<div class="main-box">
  ...
  <div class="mypage-menu">
    <div class="menu-box">
      <ul>
        ...
        <li><a class="active" href="chat-list.php">채팅</a></li>
      </ul>
    </div>
  </div>
  ...
  <section class="content" role="main" tabindex="0">
    <h2>구매 채팅</h2>
    <ol>
      <li><a href="chat.php">[파이썬으로 경험하는 빅데이터 분석과 머신러닝]<span>[구매중]</span> 2025.x.x</a></li>
      <li><a href="#">[젊은이를 위한 인간관계의 심리학(제3판)]<span>[구매중]</span> 2025.x.x</a></li>
    </ol>

    <h2 style="margin-top: 45px;">판매 채팅</h2>
    <ol>
      <li><a href="#">[쉽게 배우는 데이터 통신과 컴퓨터 네트워크]<span>[판매중]</span> 2025.x.x</a></li>
      <li><a href="#">[리눅스시스템 원리와 실제]<span>[판매중]</span> 2025.x.x</a></li>
    </ol>
  </section>
</div>
