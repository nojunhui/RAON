...
// 내 정보 카운트 (등록 책, 관심책, 판매완료, 채팅 중인 상대)
$count_sqls = [
    ...
    // 'chat_count' => "SELECT COUNT(DISTINCT other_id) FROM Chats WHERE user_id='$student_id' OR other_id='$student_id'"
];
$counts = [];
    ...
    <div class="mypage-main">
        ...
        <div class="myinfo-box">
            ...
            <div class="myinfo-stats">
                ...
                <!--<span><span class="num"><?=$counts['chat_count']?></span> - 채팅 중인 상대</span> -->
