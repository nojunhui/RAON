...
<head>
  ...
  <title>RAON 마이페이지 - 등록한 글 목록 </title>
  ...
  <div class="container">
    ...
    <main class="main">
      ...
      <section class="content" role="main" tabindex="0">
        <h2> 등록한 글 목록 </h2>
        <ul class="post-list">
          <li><a href="#">1. [ 쉽게 배우는 데이터 통신과 컴퓨터 네트워크 ]      [ 한빛미디어 ]      [ 2025.x.x ]</a></li>
          <li><a href="#">2. [ 리눅스시스템 원리와 실제 ]      [ 생능출판사 ] [ 2025.x.x ]</a></li>
          <li><a href="#">3. [ 데이터베이스 배움터 ]      [ 생능출판사 ]      [ 2025.x.x ]</a></li>
        </ul>
      </section>
    </main>
  </div>
